    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li id="route" hidden>{{Request::path()}}</li>
                <li id="adminindex">
...
<div id="right-panel" class="right-panel" style="height: 80%;">
    ...
    <header id="header" class="header">
        <div class="top-left" style="height: 100%;width:auto;">
            <div class="navbar-header" style="height: 100%;width:auto;">
                <a class="navbar-brand" style="height: 100%;width:auto;" href="./"><img src="/images/logo.png" style="height: 100%;width:auto;" alt="Logo"></a>
                <a class="navbar-brand hidden" style="height: 100%;width:auto;" href="./"><img src="/images/logo2.png" style="height: 100%;width:auto;" alt="Logo"></a>
