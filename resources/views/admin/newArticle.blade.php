                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">新增文章</strong>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-lg-12" style=" z-index:2">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="title" type="text" placeholder="Title" class="form-control form-control-success">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4" style="width:240px;height:auto;">
                                                <div class="fileinput-new thumbnail img-raised">
                                                    <img style="width:100%;height:auto;" onclick="upload()" id="preview" src="/images/tupian.png" rel="nofollow" alt="...">
                                                </div>
